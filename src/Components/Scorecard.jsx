  ...
  return (
    <div className='h-screen w-full bg-[#343434] overflow-none'>
        <div className='w-full h-[100px] bg-[#575757] flex justify-center items-center font-serif'>
            <p className='text-white font-bold text-[4rem]'>SCORECARD</p>
        </div>
    <div className='w-full h-[55%] bg-[#343434] flex justify-around items-start mt-[100px]'>
        <div className='flex flex-col justify-center items-center mr-[20px]'>
        <p className='text-[5.0rem] text-white font-bold font-sans'>You</p>
        <p className='text-[5.0rem] text-white font-bold font-sans'>{context.wins}</p>
        </div>
        <div className='flex flex-col justify-center items-center ml-[30px]'>
        <p className='text-[5.0rem] text-white font-bold font-sans'>Draws</p>
        <p className='text-[5.0rem] text-white font-bold font-sans'>{context.draws}</p>
        </div>
        <div className='flex flex-col justify-center items-center'>
            <p className='text-[5.0rem] text-white font-bold font-sans'>Computer</p>
            <p className='text-[5.0rem] text-white font-bold font-sans'>{context.loses}</p>
        </div>
